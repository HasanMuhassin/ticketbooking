...
<body>
    <header class="h1">
        ...
        <nav class="nav">
            <ul class="nbar">
                ...
                <li><a href="movie3.php" class="active">MOVIE</a></li>
    ...
    <section class="main-movie-image" id="im">
        <img src="image/movie04.jpg" alt="photo" class="mmovie-image" id="mimg">
        <div class="main-movie-text">
            <h1 class="main-movie-title"><a id="mname">Thunivu</a></h1>
            <p>Now Showing</p>
    ...
    <div class="about-movie">
        <div class="about">
            <h1 class="about-movie-title">
                <a id="mname">Thunivu</a></h1>
            <h2 class="about-movie-gender">
                <a id="mgender">Action</a></h2>
            <h1><span>About : </span></h1>
            <a id="mabout">
                <h2 class="abot-txt">
                    A masterminded man creates plan and over goes many Bank heist with his wise team, but their motive is mystery.
                </h2>
            </a>
            <h2 class="movie-dir">
                <span>Director: </span>
                <a id="mdir">H. Vinoth</a>
            </h2>
            <h2 class="movie-lan">
                <span>Languages: </span>
                <a id="mlang">Tamil</a>
