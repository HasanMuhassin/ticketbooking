            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <div class="moive-add-title">
                            <h1 class="addtitle">DELETE MOVIE</h1>
                        </div>
                ...
                <div class="movie-delete">
                    <div class="delete-movie">
                        <form action="" class="demovie-detail">
                            <h2 class="movie-name">Select Movie Categories</h2>
