                    ...
                    <div class="add-show">
                        <div class="add-smovie">
                            ...
                            <div id="date1">
                                ...
                                <input name="showdate" type="text" class="movie-d1" required>
                            </div>
                            <div class="show-time">
                                <legend>Show Time</legend>
                                <div class="check1">
                                    <input type="checkbox" name="showtime" id="t1">
                                    <label for="t1" class="t1">First show 8.00 AM</label>
                                    <input type="checkbox" name="showtime" id="t2">
                                    <label for="t2" class="t1">Second show 2.00 PM</label>
                                </div>
                                <div class="check2">
                                    <input type="checkbox" name="showtime" id="t3">
                                    <label for="t3" class="t1">Third show 6.30 PM</label>
                                    <input type="checkbox" name="showtime" id="t4">
                                    <label for="t4" class="t1">Last show 9.30 PM</label>
                                </div>
                            </div>                                                                                                       
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="submit" name="showadd" class="btn btn-primary">Add Movie</button>
                            </div>                           
                        </div>
                </form> 
            </div>
