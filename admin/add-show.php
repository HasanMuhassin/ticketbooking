            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <div class="moive-add-title">
                            <h1 class="addtitle">ADD MOVIE SHOW DATE AND TIME</h1>
                        </div>
                ...
                <div class="add-show">
                    <div class="add-smovie">
                        <form action="" class="show-detail">
                            <h1 class="moive-name">Select Movie Categories</h1>
                            <select name="show-type" id="showti">
                            ...
                            <div id="date1">
                                ...
                                <input name="showdate" type="date" class="movie-d1">
                            </div>
                            <div class="show-time">
                            ...
                            <div class="show-btn" action="">
                                <button type="submit" class="addshow-btn">
                                        Add
                                </button>
                                <button class="cancelshow-btn">
                                        Cancel
                                </button>
                            </div>
                        </form>
