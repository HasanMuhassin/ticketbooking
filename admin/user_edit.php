            ...
            <form action="userbd.php" method="POST">
                <input type="hidden" name="edit_id" value="<?php echo $row['id'];?>">
                    <div class="list1">
                        ...
                        <input type="text" class="i1" name="edit_username"  value="<?php echo $row['username'];?>" placeholder="Enter username">
                    </div>
                    <div class="list2">
                        <label>Email</label><br>
                        <input type="email" class="i2" name="edit_email" value="<?php echo $row['email'];?>" placeholder="Email address" >
                    </div>
                    <div class="list3">
                        <label>Password</label><br>
                        <input type="password" class="i3" name="edit_password" value="<?php echo $row['password'];?>" placeholder="Password" >
                    </div>
